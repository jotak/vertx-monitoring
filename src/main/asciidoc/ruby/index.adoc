...
Note: all metrics here may receive a "remote" label, but it is deactivated by default. See `link:../dataobjects.html#VertxMonitoringOptions#set_enable_remote_label_for_servers-instance_method[enableRemoteLabelForServers]`
