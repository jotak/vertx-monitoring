...
public class VertxMonitoringOptionsConverter {
  ...
  public static void fromJson(JsonObject json, VertxMonitoringOptions obj) {
    if (json.getValue("backendOptions") instanceof JsonObject) {
      obj.setBackendOptions(new io.vertx.monitoring.backend.MonitoringBackendOptions((JsonObject)json.getValue("backendOptions")));
    }
    if (json.getValue("disabledMetricsCategories") instanceof JsonArray) {
      java.util.HashSet<io.vertx.monitoring.MetricsCategory> list = new java.util.HashSet<>();
  ...
  public static void toJson(VertxMonitoringOptions obj, JsonObject json) {
    if (obj.getBackendOptions() != null) {
      json.put("backendOptions", obj.getBackendOptions().toJson());
    }
