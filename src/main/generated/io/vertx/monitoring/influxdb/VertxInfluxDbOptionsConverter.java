...
/**
 * Converter for {@link io.vertx.monitoring.influxdb.VertxInfluxDbOptions}.
 *
 * NOTE: This class has been automatically generated from the {@link io.vertx.monitoring.influxdb.VertxInfluxDbOptions} original class using Vert.x codegen.
 */
public class VertxInfluxDbOptionsConverter {
  ...
  public static void fromJson(JsonObject json, VertxInfluxDbOptions obj) {
    if (json.getValue("authenticationOptions") instanceof JsonObject) {
      obj.setAuthenticationOptions(new io.vertx.monitoring.influxdb.AuthenticationOptions((JsonObject)json.getValue("authenticationOptions")));
    }
